...
var expectedV2ComplianceGaps = map[string]bool{
	...
	"package_import_errors":               true,
	"package_import_go_scanner":           true,
	"package_import_io":                   true,
	"package_import_io_fs":                true,
	"package_import_maps":                 true,
	"package_import_pkg_errors":           true,
	...
	"variadic_function_call":              true,
	"variadic_interface_method":           true,
	"variadic_interface_param":            true,
	"varref":                              true,
