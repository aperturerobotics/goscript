...
export async function main(): Promise<void> {
	...
	let { ok: ok1 } = $.typeAssert<MyStruct | null>(i1, {kind: $.TypeKind.Pointer, elemType: 'MyStruct'})
	...
	let { ok: ok2 } = $.typeAssert<MyStruct | null>(i2, {kind: $.TypeKind.Pointer, elemType: 'MyStruct'})
	...
	let i3a: null | any = p1
	let i3b: null | any = p2
	let { ok: ok3a } = $.typeAssert<MyStruct | null>(i3a, {kind: $.TypeKind.Pointer, elemType: 'MyStruct'})
	let { ok: ok3b } = $.typeAssert<MyStruct | null>(i3b, {kind: $.TypeKind.Pointer, elemType: 'MyStruct'})
	...
	// variable pointer
	let i4b: null | any = p4
	let { ok: ok4a } = $.typeAssert<MyStruct | null>(i4a, {kind: $.TypeKind.Pointer, elemType: 'MyStruct'})
	let { ok: ok4b } = $.typeAssert<MyStruct | null>(i4b, {kind: $.TypeKind.Pointer, elemType: 'MyStruct'})
	...
	let i5: null | any = p5b
	let { ok: ok5 } = $.typeAssert<MyStruct | null>(i5, {kind: $.TypeKind.Pointer, elemType: 'MyStruct'})
	...
	let i6b: null | any = p6
	let { ok: ok6a } = $.typeAssert<MyStruct | null>(i6a, {kind: $.TypeKind.Pointer, elemType: 'MyStruct'})
	let { ok: ok6b } = $.typeAssert<MyStruct | null>(i6b, {kind: $.TypeKind.Pointer, elemType: 'MyStruct'})
	let { ok: ok6c } = $.typeAssert<MyStruct>(i6a, 'MyStruct')
