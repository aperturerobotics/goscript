...
export class node {
	...
	static __typeInfo = $.registerStructType(
		...
		[],
		node,
		[{ name: "next", key: "next", type: { kind: $.TypeKind.Pointer, elemType: "main.node" }, pkgPath: "github.com/aperturerobotics/goscript/tests/tests/typed_nil_pointer_conversion", index: [0], offset: 0, exported: false }]
	)
}
...
export async function main(): globalThis.Promise<void> {
	...
	let boxed: any = $.interfaceValue<any>(null, "*main.node")
