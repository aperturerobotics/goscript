...
export class byteSink {
	...
	static __typeInfo = $.registerStructType(
		...
		byteSink,
		[{ name: "data", key: "data", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } }, pkgPath: "github.com/aperturerobotics/goscript/tests/tests/runtime_trace_proof", index: [0], offset: 0, exported: false }]
	)
}
