...
export class buffer {
	...
	static __typeInfo = $.registerStructType(
		...
		[],
		buffer,
		[{ name: "buf", key: "buf", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } }, pkgPath: "github.com/aperturerobotics/goscript/tests/tests/composite_literal_field_shadow", index: [0], offset: 0, exported: false }]
	)
}
