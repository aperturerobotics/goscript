...
export class blockType {
	...
	constructor(init?: Partial<{typeID?: string, _constructor?: (() => any | globalThis.Promise<any>) | null}>) {
		this._fields = {
			typeID: $.varRef(init?.typeID ?? ""),
			_constructor: $.varRef(init?._constructor ?? null)
		}
	}
