...
export class ObjectID {
	...
	static __typeInfo = $.registerStructType(
		...
		ObjectID,
		[{ name: "hash", key: "hash", type: { kind: $.TypeKind.Array, elemType: { kind: $.TypeKind.Basic, name: "uint8" }, length: 4 }, pkgPath: "github.com/aperturerobotics/goscript/tests/tests/struct_equality", index: [0], offset: 0, exported: false }, { name: "format", key: "format", type: { kind: $.TypeKind.Basic, name: "uint8" }, pkgPath: "github.com/aperturerobotics/goscript/tests/tests/struct_equality", index: [1], offset: 4, exported: false }]
	)
}
