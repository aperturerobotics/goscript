...
export class Promise {
	...
	static __typeInfo = $.registerStructType(
		...
		[],
		Promise,
		[{ name: "value", key: "value", type: { kind: $.TypeKind.Basic, name: "string" }, pkgPath: "github.com/s4wave/goscript/tests/tests/promise_type_name_shadow", index: [0], offset: 0, exported: false }]
	)
}
