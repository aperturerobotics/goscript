...
import (
	...
	"github.com/s4wave/goscript/tests/tests/linkname_alias/target"
)
...
//go:linkname greet github.com/s4wave/goscript/tests/tests/linkname_alias/target.Greet
func greet(name string) string

//go:linkname add github.com/s4wave/goscript/tests/tests/linkname_alias/target.Add
