...
export class floatInfo {
	...
	static __typeInfo = $.registerStructType(
		...
		[],
		floatInfo,
		[{ name: "mantbits", key: "mantbits", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "github.com/s4wave/goscript/tests/tests/cross_file_varref_struct_field", index: [0], offset: 0, exported: false }, { name: "expbits", key: "expbits", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "github.com/s4wave/goscript/tests/tests/cross_file_varref_struct_field", index: [1], offset: 8, exported: false }]
	)
}
