...
export class item {
	...
	static __typeInfo = $.registerStructType(
		...
		[],
		item,
		[{ name: "value", key: "value", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "github.com/s4wave/goscript/tests/tests/package_tuple_blank_var", index: [0], offset: 0, exported: false }]
	)
}
