...
export async function main(): globalThis.Promise<void> {
	...
	await __goscript_server.Server.prototype.Handle.call(server, $.interfaceValue<io.ReadWriteCloser | null>(new localReadWriteCloser(), "*main.localReadWriteCloser"))
	$.println("ok")
}
