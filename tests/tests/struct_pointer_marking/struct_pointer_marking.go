...
func main() {
	...
	var iOriginal any = original // struct value in interface
	var jAlias any = pAlias      // struct pointer in interface
	...
	var iVar any = pVar // VarRef in interface
	var iLit any = pLit // marked struct in interface
	...
	arr := []any{nested1, nested2, &nested2}
