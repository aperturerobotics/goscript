...
import "@goscript/github.com/aperturerobotics/goscript/tests/tests/rune_const_reference/subpkg/index.js"
...
export async function main(): globalThis.Promise<void> {
	...
	$.println("separator used in function:", $.int(useInFunction($.int(47, 32)), 32))
	$.println("newline used in function:", $.int(useInFunction($.int(10, 32)), 32))
}
