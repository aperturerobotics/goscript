...
export class storage {
	...
	static __typeInfo = $.registerStructType(
		...
		storage,
		[{ name: "bytes", key: "bytes", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } }, pkgPath: "github.com/s4wave/goscript/tests/tests/receiver_binding", index: [0], offset: 0, exported: false }, { name: "name", key: "name", type: { kind: $.TypeKind.Basic, name: "string" }, pkgPath: "github.com/s4wave/goscript/tests/tests/receiver_binding", index: [1], offset: 24, exported: false }]
	)
}
