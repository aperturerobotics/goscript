...
export class yySymType {
	...
	static __typeInfo = $.registerStructType(
		...
		[],
		yySymType,
		[{ name: "value", key: "value", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "github.com/aperturerobotics/goscript/tests/tests/line_directive_same_package_alias", index: [0], offset: 0, exported: false }]
	)
}
