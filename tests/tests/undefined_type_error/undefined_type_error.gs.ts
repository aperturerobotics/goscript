...
export class formatter {
	...
	static __typeInfo = $.registerStructType(
		...
		[],
		formatter,
		[{ name: "wid", key: "wid", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [0], offset: 0, exported: false }, { name: "prec", key: "prec", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [1], offset: 8, exported: false }, { name: "widPresent", key: "widPresent", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [2], offset: 16, exported: false }, { name: "precPresent", key: "precPresent", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [3], offset: 17, exported: false }, { name: "minus", key: "minus", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [4], offset: 18, exported: false }, { name: "plus", key: "plus", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [5], offset: 19, exported: false }, { name: "sharp", key: "sharp", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [6], offset: 20, exported: false }, { name: "space", key: "space", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [7], offset: 21, exported: false }, { name: "zero", key: "zero", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [8], offset: 22, exported: false }, { name: "plusV", key: "plusV", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [9], offset: 23, exported: false }, { name: "sharpV", key: "sharpV", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [10], offset: 24, exported: false }]
	)
}
...
export class printer {
	...
	static __typeInfo = $.registerStructType(
		...
		printer,
		[{ name: "buf", key: "buf", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [0], offset: 0, exported: false }, { name: "arg", key: "arg", type: { kind: $.TypeKind.Interface, methods: [] }, pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [1], offset: 24, exported: false }, { name: "fmt", key: "fmt", type: "main.formatter", pkgPath: "github.com/s4wave/goscript/tests/tests/undefined_type_error", index: [2], offset: 40, exported: false }]
	)
}
