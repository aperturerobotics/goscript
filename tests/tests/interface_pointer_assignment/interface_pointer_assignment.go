...
func main() {
	...
	p4 := &s4
	var i4a any = &MyStruct{Value: 70} // composite literal pointer
	var i4b any = p4                   // variable pointer
	_, ok4a := i4a.(*MyStruct)
	_, ok4b := i4b.(*MyStruct)
	...
	var i6a any = s6copy       // struct value (should fail pointer assertion)
	var i6b any = p6           // struct pointer (should succeed)
