...
export let DefaultOutput: ((pc: number, data: $.Slice<number>) => $.GoError | globalThis.Promise<$.GoError>) | null = null as unknown as ((pc: number, data: $.Slice<number>) => $.GoError | globalThis.Promise<$.GoError>) | null
