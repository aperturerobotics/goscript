...
export class Regexp {
	...
	static __typeInfo = $.registerStructType(
		"regexp.Regexp",
		() => new Regexp(),
		[{ name: "AppendText", args: [{ name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "Copy", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "regexp.Regexp" } }] }, { name: "Expand", args: [{ name: "dst", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "template", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "src", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "match", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "ExpandString", args: [{ name: "dst", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "template", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "src", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "match", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "Find", args: [{ name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "FindAll", args: [{ name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } } }] }, { name: "FindAllIndex", args: [{ name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } } }] }, { name: "FindAllString", args: [{ name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "string" } } }] }, { name: "FindAllStringIndex", args: [{ name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } } }] }, { name: "FindAllStringSubmatch", args: [{ name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "string" } } } }] }, { name: "FindAllStringSubmatchIndex", args: [{ name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } } }] }, { name: "FindAllSubmatch", args: [{ name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } } } }] }, { name: "FindAllSubmatchIndex", args: [{ name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } } }] }, { name: "FindIndex", args: [{ name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "loc", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }] }, { name: "FindReaderIndex", args: [{ name: "r", type: "io.RuneReader" }], returns: [{ name: "loc", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }] }, { name: "FindReaderSubmatchIndex", args: [{ name: "r", type: "io.RuneReader" }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }] }, { name: "FindString", args: [{ name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "string" } }] }, { name: "FindStringIndex", args: [{ name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "loc", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }] }, { name: "FindStringSubmatch", args: [{ name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "string" } } }] }, { name: "FindStringSubmatchIndex", args: [{ name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }] }, { name: "FindSubmatch", args: [{ name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } } }] }, { name: "FindSubmatchIndex", args: [{ name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }] }, { name: "LiteralPrefix", args: [], returns: [{ name: "prefix", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "complete", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "Longest", args: [], returns: [] }, { name: "MarshalText", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "_r1", type: "error" }] }, { name: "Match", args: [{ name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "MatchReader", args: [{ name: "r", type: "io.RuneReader" }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "MatchString", args: [{ name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "NumSubexp", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "ReplaceAll", args: [{ name: "src", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "repl", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "ReplaceAllFunc", args: [{ name: "src", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "repl", type: ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } }], results: [{ kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } }] } as $.FunctionTypeInfo) }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "ReplaceAllLiteral", args: [{ name: "src", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "repl", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "ReplaceAllLiteralString", args: [{ name: "src", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "repl", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "string" } }] }, { name: "ReplaceAllString", args: [{ name: "src", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "repl", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "string" } }] }, { name: "ReplaceAllStringFunc", args: [{ name: "src", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "repl", type: ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Basic, name: "string" }], results: [{ kind: $.TypeKind.Basic, name: "string" }] } as $.FunctionTypeInfo) }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "string" } }] }, { name: "Split", args: [{ name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "string" } } }] }, { name: "String", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "string" } }] }, { name: "SubexpIndex", args: [{ name: "name", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "SubexpNames", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "string" } } }] }, { name: "UnmarshalText", args: [{ name: "text", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [{ name: "_r0", type: "error" }] }, { name: "allMatches", args: [{ name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "n", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "deliver", type: ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } }], results: [] } as $.FunctionTypeInfo) }], returns: [] }, { name: "backtrack", args: [{ name: "ib", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "is", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "pos", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "ncap", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "dstCap", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }] }, { name: "doExecute", args: [{ name: "r", type: "io.RuneReader" }, { name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "pos", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "ncap", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "dstCap", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }] }, { name: "doMatch", args: [{ name: "r", type: "io.RuneReader" }, { name: "b", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "s", type: { kind: $.TypeKind.Basic, name: "string" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "doOnePass", args: [{ name: "ir", type: "io.RuneReader" }, { name: "ib", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "is", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "pos", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "ncap", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "dstCap", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }] }, { name: "expand", args: [{ name: "dst", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "template", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "bsrc", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "src", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "match", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "get", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "regexp.machine" } }] }, { name: "pad", args: [{ name: "a", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } } }] }, { name: "put", args: [{ name: "m", type: { kind: $.TypeKind.Pointer, elemType: "regexp.machine" } }], returns: [] }, { name: "replaceAll", args: [{ name: "bsrc", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, { name: "src", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "nmatch", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "repl", type: ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } }, { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int" } }], results: [{ kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } }] } as $.FunctionTypeInfo) }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "tryBacktrack", args: [{ name: "b", type: { kind: $.TypeKind.Pointer, elemType: "regexp.bitState" } }, { name: "i", type: "regexp.input" }, { name: "pc", type: { kind: $.TypeKind.Basic, name: "uint32" } }, { name: "pos", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }],
		Regexp,
		[{ name: "expr", key: "expr", type: { kind: $.TypeKind.Basic, name: "string" }, pkgPath: "regexp", index: [0], offset: 0, exported: false }, { name: "prog", key: "prog", type: { kind: $.TypeKind.Pointer, elemType: "syntax.Prog" }, pkgPath: "regexp", index: [1], offset: 16, exported: false }, { name: "onepass", key: "onepass", type: { kind: $.TypeKind.Pointer, elemType: "regexp.onePassProg" }, pkgPath: "regexp", index: [2], offset: 24, exported: false }, { name: "numSubexp", key: "numSubexp", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "regexp", index: [3], offset: 32, exported: false }, { name: "maxBitStateLen", key: "maxBitStateLen", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "regexp", index: [4], offset: 40, exported: false }, { name: "subexpNames", key: "subexpNames", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "string" } }, pkgPath: "regexp", index: [5], offset: 48, exported: false }, { name: "prefix", key: "prefix", type: { kind: $.TypeKind.Basic, name: "string" }, pkgPath: "regexp", index: [6], offset: 72, exported: false }, { name: "prefixBytes", key: "prefixBytes", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } }, pkgPath: "regexp", index: [7], offset: 88, exported: false }, { name: "prefixRune", key: "prefixRune", type: { kind: $.TypeKind.Basic, name: "int32" }, pkgPath: "regexp", index: [8], offset: 112, exported: false }, { name: "prefixEnd", key: "prefixEnd", type: { kind: $.TypeKind.Basic, name: "uint32" }, pkgPath: "regexp", index: [9], offset: 116, exported: false }, { name: "mpool", key: "mpool", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "regexp", index: [10], offset: 120, exported: false }, { name: "matchcap", key: "matchcap", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "regexp", index: [11], offset: 128, exported: false }, { name: "prefixComplete", key: "prefixComplete", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "regexp", index: [12], offset: 136, exported: false }, { name: "cond", key: "cond", type: { kind: $.TypeKind.Basic, name: "uint8", typeName: "syntax.EmptyOp" }, pkgPath: "regexp", index: [13], offset: 137, exported: false }, { name: "minInputLen", key: "minInputLen", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "regexp", index: [14], offset: 144, exported: false }, { name: "longest", key: "longest", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "regexp", index: [15], offset: 152, exported: false }]
	)
}
...
export class inputString {
	...
	static __typeInfo = $.registerStructType(
		...
		inputString,
		[{ name: "str", key: "str", type: { kind: $.TypeKind.Basic, name: "string" }, pkgPath: "regexp", index: [0], offset: 0, exported: false }]
	)
}
...
export class inputBytes {
	...
	static __typeInfo = $.registerStructType(
		...
		[{ name: "canCheckPrefix", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "context", args: [{ name: "pos", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "uint64", typeName: "regexp.lazyFlag" } }] }, { name: "hasPrefix", args: [{ name: "re", type: { kind: $.TypeKind.Pointer, elemType: "regexp.Regexp" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "index", args: [{ name: "re", type: { kind: $.TypeKind.Pointer, elemType: "regexp.Regexp" } }, { name: "pos", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "step", args: [{ name: "pos", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int32" } }, { name: "_r1", type: { kind: $.TypeKind.Basic, name: "int" } }] }],
		inputBytes,
		[{ name: "str", key: "str", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } }, pkgPath: "regexp", index: [0], offset: 0, exported: false }]
	)
}
...
export class inputReader {
	...
	static __typeInfo = $.registerStructType(
		...
		[{ name: "canCheckPrefix", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "context", args: [{ name: "pos", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "uint64", typeName: "regexp.lazyFlag" } }] }, { name: "hasPrefix", args: [{ name: "re", type: { kind: $.TypeKind.Pointer, elemType: "regexp.Regexp" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "index", args: [{ name: "re", type: { kind: $.TypeKind.Pointer, elemType: "regexp.Regexp" } }, { name: "pos", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "step", args: [{ name: "pos", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int32" } }, { name: "_r1", type: { kind: $.TypeKind.Basic, name: "int" } }] }],
		inputReader,
		[{ name: "r", key: "r", type: "io.RuneReader", pkgPath: "regexp", index: [0], offset: 0, exported: false }, { name: "atEOT", key: "atEOT", type: { kind: $.TypeKind.Basic, name: "bool" }, pkgPath: "regexp", index: [1], offset: 16, exported: false }, { name: "pos", key: "pos", type: { kind: $.TypeKind.Basic, name: "int" }, pkgPath: "regexp", index: [2], offset: 24, exported: false }]
	)
}
