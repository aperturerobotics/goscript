...
export class Regexp {
	...
	static __typeInfo = $.registerStructType(
		"syntax.Regexp",
		() => new Regexp(),
		[{ name: "CapNames", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "string" } } }] }, { name: "Equal", args: [{ name: "y", type: { kind: $.TypeKind.Pointer, elemType: "syntax.Regexp" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "bool" } }] }, { name: "MaxCap", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "Simplify", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Pointer, elemType: "syntax.Regexp" } }] }, { name: "String", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "string" } }] }, { name: "capNames", args: [{ name: "names", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "string" } } }], returns: [] }],
		Regexp,
		[{ name: "Op", key: "Op", type: { kind: $.TypeKind.Basic, name: "uint8", typeName: "syntax.Op" }, index: [0], offset: 0, exported: true }, { name: "Flags", key: "Flags", type: { kind: $.TypeKind.Basic, name: "uint16", typeName: "syntax.Flags" }, index: [1], offset: 2, exported: true }, { name: "Sub", key: "Sub", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Pointer, elemType: "syntax.Regexp" } }, index: [2], offset: 8, exported: true }, { name: "Sub0", key: "Sub0", type: { kind: $.TypeKind.Array, elemType: { kind: $.TypeKind.Pointer, elemType: "syntax.Regexp" }, length: 1 }, index: [3], offset: 32, exported: true }, { name: "Rune", key: "Rune", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "int32" } }, index: [4], offset: 40, exported: true }, { name: "Rune0", key: "Rune0", type: { kind: $.TypeKind.Array, elemType: { kind: $.TypeKind.Basic, name: "int32" }, length: 2 }, index: [5], offset: 64, exported: true }, { name: "Min", key: "Min", type: { kind: $.TypeKind.Basic, name: "int" }, index: [6], offset: 72, exported: true }, { name: "Max", key: "Max", type: { kind: $.TypeKind.Basic, name: "int" }, index: [7], offset: 80, exported: true }, { name: "Cap", key: "Cap", type: { kind: $.TypeKind.Basic, name: "int" }, index: [8], offset: 88, exported: true }, { name: "Name", key: "Name", type: { kind: $.TypeKind.Basic, name: "string" }, index: [9], offset: 96, exported: true }]
	)
}
