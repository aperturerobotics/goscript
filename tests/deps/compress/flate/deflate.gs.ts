...
export class compressionLevel {
	...
	static __typeInfo = $.registerStructType(
		...
		[],
		compressionLevel,
		{"level": { kind: $.TypeKind.Basic, name: "int" }, "good": { kind: $.TypeKind.Basic, name: "int" }, "lazy": { kind: $.TypeKind.Basic, name: "int" }, "nice": { kind: $.TypeKind.Basic, name: "int" }, "chain": { kind: $.TypeKind.Basic, name: "int" }, "fastSkipHashing": { kind: $.TypeKind.Basic, name: "int" }}
	)
}
