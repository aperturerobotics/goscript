...
export class dictDecoder {
	...
	static __typeInfo = $.registerStructType(
		"flate.dictDecoder",
		() => new dictDecoder(),
		[{ name: "availRead", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "availWrite", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "histSize", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "init", args: [{ name: "size", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "dict", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }], returns: [] }, { name: "readFlush", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }, { name: "tryWriteCopy", args: [{ name: "dist", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "length", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "writeByte", args: [{ name: "c", type: { kind: $.TypeKind.Basic, name: "uint8" } }], returns: [] }, { name: "writeCopy", args: [{ name: "dist", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "length", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ name: "_r0", type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "writeMark", args: [{ name: "cnt", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [] }, { name: "writeSlice", args: [], returns: [{ name: "_r0", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }] }],
		dictDecoder,
