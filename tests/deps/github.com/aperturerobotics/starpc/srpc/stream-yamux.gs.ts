...
export class yamuxStream {
	...
	public yamux(): yamux2.Stream | $.VarRef<yamux2.Stream> | null {
		const s: yamuxStream | $.VarRef<yamuxStream> | null = this
		return (s as unknown as yamux2.Stream | $.VarRef<yamux2.Stream> | null)
	}

	static __typeInfo = $.registerStructType(
		"srpc.yamuxStream",
		() => new yamuxStream(),
		[{ name: "Close", args: [], returns: [] }, { name: "CloseRead", args: [], returns: [] }, { name: "CloseWrite", args: [], returns: [] }, { name: "Read", args: [], returns: [] }, { name: "Reset", args: [], returns: [] }, { name: "SetDeadline", args: [], returns: [] }, { name: "SetReadDeadline", args: [], returns: [] }, { name: "SetWriteDeadline", args: [], returns: [] }, { name: "Write", args: [], returns: [] }, { name: "yamux", args: [], returns: [] }],
		yamuxStream,
