...
export class commonRPC {
	...
	static __typeInfo = $.registerStructType(
		...
		commonRPC,
		{"ctx": "context.Context", "ctxCancel": ({ kind: $.TypeKind.Function, name: "context.CancelFunc", params: [], results: [] } as $.FunctionTypeInfo), "service": { kind: $.TypeKind.Basic, name: "string" }, "method": { kind: $.TypeKind.Basic, name: "string" }, "localCompleted": "atomic.Bool", "bcast": "broadcast.Broadcast", "writer": "srpc.PacketWriter", "writerClosed": { kind: $.TypeKind.Basic, name: "bool" }, "dataQueue": { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "uint8" } } }, "dataClosed": { kind: $.TypeKind.Basic, name: "bool" }, "remoteErr": "error"}
	)
}
