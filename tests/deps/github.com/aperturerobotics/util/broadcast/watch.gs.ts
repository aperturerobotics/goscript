...
export async function WatchBroadcast(__typeArgs: $.GenericTypeArgs | undefined, ctx: context.Context | null, bcast: __goscript_broadcast.Broadcast | $.VarRef<__goscript_broadcast.Broadcast> | null, snapshot: (() => any) | null, send: ((_p0: any) => $.GoError) | null): Promise<$.GoError> {
	return await WatchBroadcastWithEqual(undefined, ctx, bcast, snapshot, send, null)
}

export async function WatchBroadcastWithEqual(__typeArgs: $.GenericTypeArgs | undefined, ctx: context.Context | null, bcast: __goscript_broadcast.Broadcast | $.VarRef<__goscript_broadcast.Broadcast> | null, snapshot: (() => any) | null, send: ((_p0: any) => $.GoError) | null, equal: ((a: any, b: any) => boolean) | null): Promise<$.GoError> {
	let ch: $.Channel<{}> | null = null
	let val: any = $.genericZero(__typeArgs, "T", null)
	await $.pointerValue<__goscript_broadcast.Broadcast>(bcast).HoldLock($.functionValue((_: (() => void) | null, getWaitCh: (() => $.Channel<{}> | null) | null): void => {
		ch = getWaitCh!()
		val = snapshot!()
...
export async function WatchBroadcastVT(__typeArgs: $.GenericTypeArgs | undefined, ctx: context.Context | null, bcast: __goscript_broadcast.Broadcast | $.VarRef<__goscript_broadcast.Broadcast> | null, snapshot: (() => any) | null, send: ((_p0: any) => $.GoError) | null): Promise<$.GoError> {
