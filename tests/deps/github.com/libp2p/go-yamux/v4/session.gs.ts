...
export class nullMemoryManagerImpl {
	...
	static __typeInfo = $.registerStructType(
		...
		[{ name: "Done", args: [], returns: [] }, { name: "ReleaseMemory", args: [], returns: [] }, { name: "ReserveMemory", args: [], returns: [] }],
...
export class Session {
	...
	static __typeInfo = $.registerStructType(
		"yamux.Session",
		() => new Session(),
		[{ name: "Accept", args: [], returns: [] }, { name: "AcceptStream", args: [], returns: [] }, { name: "Addr", args: [], returns: [] }, { name: "Close", args: [], returns: [] }, { name: "CloseChan", args: [], returns: [] }, { name: "GoAway", args: [], returns: [] }, { name: "IsClosed", args: [], returns: [] }, { name: "LocalAddr", args: [], returns: [] }, { name: "NumStreams", args: [], returns: [] }, { name: "Open", args: [], returns: [] }, { name: "OpenStream", args: [], returns: [] }, { name: "Ping", args: [], returns: [] }, { name: "RemoteAddr", args: [], returns: [] }, { name: "closeStream", args: [], returns: [] }, { name: "deleteStream", args: [], returns: [] }, { name: "establishStream", args: [], returns: [] }, { name: "exitErr", args: [], returns: [] }, { name: "extendKeepalive", args: [], returns: [] }, { name: "getRTT", args: [], returns: [] }, { name: "goAway", args: [], returns: [] }, { name: "handleGoAway", args: [], returns: [] }, { name: "handlePing", args: [], returns: [] }, { name: "handleStreamMessage", args: [], returns: [] }, { name: "incomingStream", args: [], returns: [] }, { name: "measureRTT", args: [], returns: [] }, { name: "recv", args: [], returns: [] }, { name: "recvLoop", args: [], returns: [] }, { name: "send", args: [], returns: [] }, { name: "sendLoop", args: [], returns: [] }, { name: "sendMsg", args: [], returns: [] }, { name: "startKeepalive", args: [], returns: [] }, { name: "startMeasureRTT", args: [], returns: [] }, { name: "stopKeepalive", args: [], returns: [] }],
		Session,
