...
export class Stream {
	...
	public async sendWindowUpdate(deadline: $.Channel<{}> | null): globalThis.Promise<$.GoError> {
		...
		let now = $.markAsStructValue($.cloneStructValue(time.Now()))
		{
			...
			if ((($.uint(flags, 16) == $.uint(0, 16)) && (rtt > 0)) && ($.markAsStructValue($.cloneStructValue(now)).Sub($.markAsStructValue($.cloneStructValue($.pointerValue<Stream>(s).epochStart))) < ($.int64Mul(rtt, 4)))) {
				let recvWindow: number = 0
				if ($.pointerValue<Stream>(s).recvWindow > (Math.trunc(math.MaxUint32 / 2))) {
	...
	static __typeInfo = $.registerStructType(
		"yamux.Stream",
		() => new Stream(),
		[{ name: "Close", args: [], returns: [] }, { name: "CloseRead", args: [], returns: [] }, { name: "CloseWrite", args: [], returns: [] }, { name: "LocalAddr", args: [], returns: [] }, { name: "Read", args: [], returns: [] }, { name: "RemoteAddr", args: [], returns: [] }, { name: "Reset", args: [], returns: [] }, { name: "Session", args: [], returns: [] }, { name: "SetDeadline", args: [], returns: [] }, { name: "SetReadDeadline", args: [], returns: [] }, { name: "SetWriteDeadline", args: [], returns: [] }, { name: "StreamID", args: [], returns: [] }, { name: "Write", args: [], returns: [] }, { name: "cleanup", args: [], returns: [] }, { name: "forceClose", args: [], returns: [] }, { name: "incrSendWindow", args: [], returns: [] }, { name: "notifyWaiting", args: [], returns: [] }, { name: "processFlags", args: [], returns: [] }, { name: "readData", args: [], returns: [] }, { name: "sendClose", args: [], returns: [] }, { name: "sendFlags", args: [], returns: [] }, { name: "sendReset", args: [], returns: [] }, { name: "sendWindowUpdate", args: [], returns: [] }, { name: "write", args: [], returns: [] }],
		Stream,
		{"sendWindow": { kind: $.TypeKind.Basic, name: "uint32" }, "memorySpan": "yamux.MemoryManager", "id": { kind: $.TypeKind.Basic, name: "uint32" }, "session": { kind: $.TypeKind.Pointer, elemType: "yamux.Session" }, "recvWindow": { kind: $.TypeKind.Basic, name: "uint32" }, "epochStart": "time.Time", "state": { kind: $.TypeKind.Basic, name: "int", typeName: "yamux.streamState" }, "writeState": { kind: $.TypeKind.Basic, name: "int", typeName: "yamux.halfStreamState" }, "readState": { kind: $.TypeKind.Basic, name: "int", typeName: "yamux.halfStreamState" }, "stateLock": "sync.Mutex", "recvBuf": "yamux.segmentedBuffer", "recvNotifyCh": { kind: $.TypeKind.Channel, direction: "both", elemType: { kind: $.TypeKind.Struct, methods: [], fields: {} } }, "sendNotifyCh": { kind: $.TypeKind.Channel, direction: "both", elemType: { kind: $.TypeKind.Struct, methods: [], fields: {} } }, "readDeadline": "yamux.pipeDeadline", "writeDeadline": "yamux.pipeDeadline"}
	)
}
