...
export class MutexWrap {
	...
	static __typeInfo = $.registerStructType(
		...
		MutexWrap,
		{"lock": "sync.Mutex", "disabled": { kind: $.TypeKind.Basic, name: "bool" }}
	)
}
...
export class Logger {
	...
	static __typeInfo = $.registerStructType(
		...
		Logger,
		{"Out": "io.Writer", "Hooks": "logrus.LevelHooks", "Formatter": "logrus.Formatter", "ReportCaller": { kind: $.TypeKind.Basic, name: "bool" }, "Level": { kind: $.TypeKind.Basic, name: "uint32", typeName: "logrus.Level" }, "mu": "logrus.MutexWrap", "entryPool": "sync.Pool", "ExitFunc": ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Basic, name: "int" }], results: [] } as $.FunctionTypeInfo), "BufferPool": "logrus.BufferPool"}
	)
}
