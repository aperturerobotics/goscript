...
export class TextFormatter {
	...
	static __typeInfo = $.registerStructType(
		...
		() => new TextFormatter(),
		[{ name: "Format", args: [], returns: [] }, { name: "appendBytes", args: [], returns: [] }, { name: "appendKeyValue", args: [], returns: [] }, { name: "appendNumeric", args: [], returns: [] }, { name: "appendString", args: [], returns: [] }, { name: "appendValue", args: [], returns: [] }, { name: "isColored", args: [], returns: [] }, { name: "isTerminal", args: [], returns: [] }, { name: "printColored", args: [], returns: [] }, { name: "printPlain", args: [], returns: [] }],
		TextFormatter,
		{"ForceColors": { kind: $.TypeKind.Basic, name: "bool" }, "DisableColors": { kind: $.TypeKind.Basic, name: "bool" }, "ForceQuote": { kind: $.TypeKind.Basic, name: "bool" }, "DisableQuote": { kind: $.TypeKind.Basic, name: "bool" }, "EnvironmentOverrideColors": { kind: $.TypeKind.Basic, name: "bool" }, "DisableTimestamp": { kind: $.TypeKind.Basic, name: "bool" }, "FullTimestamp": { kind: $.TypeKind.Basic, name: "bool" }, "TimestampFormat": { kind: $.TypeKind.Basic, name: "string" }, "DisableSorting": { kind: $.TypeKind.Basic, name: "bool" }, "SortingFunc": ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Basic, name: "string" } }], results: [] } as $.FunctionTypeInfo), "DisableLevelTruncation": { kind: $.TypeKind.Basic, name: "bool" }, "PadLevelText": { kind: $.TypeKind.Basic, name: "bool" }, "QuoteEmptyFields": { kind: $.TypeKind.Basic, name: "bool" }, "terminal": { kind: $.TypeKind.Basic, name: "bool" }, "FieldMap": "logrus.FieldMap", "CallerPrettyfier": ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Pointer, elemType: "runtime.Frame" }], results: [{ kind: $.TypeKind.Basic, name: "string" }, { kind: $.TypeKind.Basic, name: "string" }] } as $.FunctionTypeInfo), "terminalInitOnce": "sync.Once"}
	)
}
