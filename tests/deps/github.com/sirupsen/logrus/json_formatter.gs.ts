...
export class JSONFormatter {
	...
	static __typeInfo = $.registerStructType(
		...
		JSONFormatter,
		{"TimestampFormat": { kind: $.TypeKind.Basic, name: "string" }, "DisableTimestamp": { kind: $.TypeKind.Basic, name: "bool" }, "DisableHTMLEscape": { kind: $.TypeKind.Basic, name: "bool" }, "DataKey": { kind: $.TypeKind.Basic, name: "string" }, "FieldMap": "logrus.FieldMap", "CallerPrettyfier": ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Pointer, elemType: "runtime.Frame" }], results: [{ kind: $.TypeKind.Basic, name: "string" }, { kind: $.TypeKind.Basic, name: "string" }] } as $.FunctionTypeInfo), "PrettyPrint": { kind: $.TypeKind.Basic, name: "bool" }}
	)
}
