...
export class Dialer {
	...
	static __typeInfo = $.registerStructType(
		"net.Dialer",
		() => new Dialer(),
		[{ name: "Dial", args: [], returns: [] }, { name: "DialContext", args: [], returns: [] }, { name: "DialIP", args: [], returns: [] }, { name: "DialTCP", args: [], returns: [] }, { name: "DialUDP", args: [], returns: [] }, { name: "DialUnix", args: [], returns: [] }, { name: "MultipathTCP", args: [], returns: [] }, { name: "SetMultipathTCP", args: [], returns: [] }, { name: "deadline", args: [], returns: [] }, { name: "dialCtx", args: [], returns: [] }, { name: "dualStack", args: [], returns: [] }, { name: "fallbackDelay", args: [], returns: [] }, { name: "resolver", args: [], returns: [] }],
		Dialer,
		{"Timeout": { kind: $.TypeKind.Basic, name: "int64", typeName: "time.Duration" }, "Deadline": "time.Time", "LocalAddr": "net.Addr", "DualStack": { kind: $.TypeKind.Basic, name: "bool" }, "FallbackDelay": { kind: $.TypeKind.Basic, name: "int64", typeName: "time.Duration" }, "KeepAlive": { kind: $.TypeKind.Basic, name: "int64", typeName: "time.Duration" }, "KeepAliveConfig": "net.KeepAliveConfig", "Resolver": { kind: $.TypeKind.Pointer, elemType: "net.Resolver" }, "Cancel": { kind: $.TypeKind.Channel, direction: "receive", elemType: { kind: $.TypeKind.Struct, methods: [], fields: {} } }, "Control": ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Basic, name: "string" }, { kind: $.TypeKind.Basic, name: "string" }, "syscall.RawConn"], results: ["error"] } as $.FunctionTypeInfo), "ControlContext": ({ kind: $.TypeKind.Function, params: ["context.Context", { kind: $.TypeKind.Basic, name: "string" }, { kind: $.TypeKind.Basic, name: "string" }, "syscall.RawConn"], results: ["error"] } as $.FunctionTypeInfo), "mptcpStatus": { kind: $.TypeKind.Basic, name: "uint8", typeName: "net.mptcpStatusDial" }}
	)
}
...
export class sysDialer {
	...
	public async dialParallel(ctx: context.Context | null, primaries: __goscript_ipsock.addrList, fallbacks: __goscript_ipsock.addrList): globalThis.Promise<[__goscript_net.Conn | null, $.GoError]> {
		...
		class dialResult {
			...
			static __typeInfo = $.registerStructType(
				"net.dialResult",
				() => new dialResult(),
				[{ name: "Close", args: [], returns: [] }, { name: "LocalAddr", args: [], returns: [] }, { name: "Read", args: [], returns: [] }, { name: "RemoteAddr", args: [], returns: [] }, { name: "SetDeadline", args: [], returns: [] }, { name: "SetReadDeadline", args: [], returns: [] }, { name: "SetWriteDeadline", args: [], returns: [] }, { name: "Write", args: [], returns: [] }, { name: "Error", args: [], returns: [] }],
				dialResult,
				{"Conn": "net.Conn", "error": "error", "primary": { kind: $.TypeKind.Basic, name: "bool" }, "done": { kind: $.TypeKind.Basic, name: "bool" }}
			)
		}
			...
			let dialCtx: context.Context | null = ctx
			{
				...
				if (hasDeadline) {
					...
					if ($.markAsStructValue($.cloneStructValue(__goscriptShadow7)).Before($.markAsStructValue($.cloneStructValue(deadline)))) {
						let cancel: context.CancelFunc | null = null as unknown as context.CancelFunc | null
	...
	static __typeInfo = $.registerStructType(
		"net.sysDialer",
		() => new sysDialer(),
		[{ name: "dialIP", args: [], returns: [] }, { name: "dialMPTCP", args: [], returns: [] }, { name: "dialParallel", args: [], returns: [] }, { name: "dialSerial", args: [], returns: [] }, { name: "dialSingle", args: [], returns: [] }, { name: "dialTCP", args: [], returns: [] }, { name: "dialUDP", args: [], returns: [] }, { name: "dialUnix", args: [], returns: [] }, { name: "doDialTCP", args: [], returns: [] }, { name: "doDialTCPProto", args: [], returns: [] }, { name: "Dial", args: [], returns: [] }, { name: "DialContext", args: [], returns: [] }, { name: "DialIP", args: [], returns: [] }, { name: "DialTCP", args: [], returns: [] }, { name: "DialUDP", args: [], returns: [] }, { name: "DialUnix", args: [], returns: [] }, { name: "MultipathTCP", args: [], returns: [] }, { name: "SetMultipathTCP", args: [], returns: [] }, { name: "deadline", args: [], returns: [] }, { name: "dialCtx", args: [], returns: [] }, { name: "dualStack", args: [], returns: [] }, { name: "fallbackDelay", args: [], returns: [] }, { name: "resolver", args: [], returns: [] }],
		sysDialer,
		{"Dialer": "net.Dialer", "network": { kind: $.TypeKind.Basic, name: "string" }, "address": { kind: $.TypeKind.Basic, name: "string" }, "testHookDialTCP": ({ kind: $.TypeKind.Function, params: ["context.Context", { kind: $.TypeKind.Basic, name: "string" }, { kind: $.TypeKind.Pointer, elemType: "net.TCPAddr" }, { kind: $.TypeKind.Pointer, elemType: "net.TCPAddr" }], results: [{ kind: $.TypeKind.Pointer, elemType: "net.TCPConn" }, "error"] } as $.FunctionTypeInfo)}
	)
}
...
export class ListenConfig {
	...
	static __typeInfo = $.registerStructType(
		"net.ListenConfig",
		() => new ListenConfig(),
		[{ name: "Listen", args: [], returns: [] }, { name: "ListenPacket", args: [], returns: [] }, { name: "MultipathTCP", args: [], returns: [] }, { name: "SetMultipathTCP", args: [], returns: [] }],
		ListenConfig,
		{"Control": ({ kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Basic, name: "string" }, { kind: $.TypeKind.Basic, name: "string" }, "syscall.RawConn"], results: ["error"] } as $.FunctionTypeInfo), "KeepAlive": { kind: $.TypeKind.Basic, name: "int64", typeName: "time.Duration" }, "KeepAliveConfig": "net.KeepAliveConfig", "mptcpStatus": { kind: $.TypeKind.Basic, name: "uint8", typeName: "net.mptcpStatusListen" }}
	)
}
...
export class sysListener {
	...
	public async listenIP(ctx: context.Context | null, laddr: __goscript_iprawsock.IPAddr | $.VarRef<__goscript_iprawsock.IPAddr> | null): globalThis.Promise<[__goscript_iprawsock.IPConn | $.VarRef<__goscript_iprawsock.IPConn> | null, $.GoError]> {
		...
		let ctrlCtxFn: ((ctx: context.Context | null, network: string, address: string, c: syscall.RawConn | null) => $.GoError | globalThis.Promise<$.GoError>) | null = null as unknown as ((ctx: context.Context | null, network: string, address: string, c: syscall.RawConn | null) => $.GoError | globalThis.Promise<$.GoError>) | null
	...
	static __typeInfo = $.registerStructType(
		"net.sysListener",
		() => new sysListener(),
		[{ name: "listenIP", args: [], returns: [] }, { name: "listenMPTCP", args: [], returns: [] }, { name: "listenMulticastUDP", args: [], returns: [] }, { name: "listenTCP", args: [], returns: [] }, { name: "listenTCPProto", args: [], returns: [] }, { name: "listenUDP", args: [], returns: [] }, { name: "listenUnix", args: [], returns: [] }, { name: "listenUnixgram", args: [], returns: [] }, { name: "Listen", args: [], returns: [] }, { name: "ListenPacket", args: [], returns: [] }, { name: "MultipathTCP", args: [], returns: [] }, { name: "SetMultipathTCP", args: [], returns: [] }],
		sysListener,
		{"ListenConfig": "net.ListenConfig", "network": { kind: $.TypeKind.Basic, name: "string" }, "address": { kind: $.TypeKind.Basic, name: "string" }}
	)
}
