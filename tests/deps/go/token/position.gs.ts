...
import { key, tree } from "./tree.gs.ts";
...
export class FileSet {
	...
	static __typeInfo = $.registerStructType(
	  'go/token.FileSet',
	  new FileSet(),
	  [{ name: "Base", args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: "int" } }] }, { name: "AddFile", args: [{ name: "filename", type: { kind: $.TypeKind.Basic, name: "string" } }, { name: "base", type: { kind: $.TypeKind.Basic, name: "int" } }, { name: "size", type: { kind: $.TypeKind.Basic, name: "int" } }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "go/token.File" } }] }, { name: "AddExistingFiles", args: [{ name: "files", type: { kind: $.TypeKind.Slice, elemType: { kind: $.TypeKind.Pointer, elemType: "go/token.File" } } }], returns: [] }, { name: "RemoveFile", args: [{ name: "file", type: { kind: $.TypeKind.Pointer, elemType: "go/token.File" } }], returns: [] }, { name: "Iterate", args: [{ name: "yield", type: { kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Pointer, elemType: "go/token.File" }], results: [{ kind: $.TypeKind.Basic, name: "bool" }] } }], returns: [] }, { name: "file", args: [{ name: "p", type: "go/token.Pos" }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "go/token.File" } }] }, { name: "File", args: [{ name: "p", type: "go/token.Pos" }], returns: [{ type: { kind: $.TypeKind.Pointer, elemType: "go/token.File" } }] }, { name: "PositionFor", args: [{ name: "p", type: "go/token.Pos" }, { name: "adjusted", type: { kind: $.TypeKind.Basic, name: "bool" } }], returns: [{ type: "go/token.Position" }] }, { name: "Position", args: [{ name: "p", type: "go/token.Pos" }], returns: [{ type: "go/token.Position" }] }, { name: "Read", args: [{ name: "decode", type: { kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Interface, methods: [] }], results: [{ kind: $.TypeKind.Interface, name: 'GoError', methods: [{ name: 'Error', args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: 'string' } }] }] }] } }], returns: [{ type: { kind: $.TypeKind.Interface, name: 'GoError', methods: [{ name: 'Error', args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: 'string' } }] }] } }] }, { name: "Write", args: [{ name: "encode", type: { kind: $.TypeKind.Function, params: [{ kind: $.TypeKind.Interface, methods: [] }], results: [{ kind: $.TypeKind.Interface, name: 'GoError', methods: [{ name: 'Error', args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: 'string' } }] }] }] } }], returns: [{ type: { kind: $.TypeKind.Interface, name: 'GoError', methods: [{ name: 'Error', args: [], returns: [{ type: { kind: $.TypeKind.Basic, name: 'string' } }] }] } }] }],
	  FileSet,
	  {"mutex": "sync.RWMutex", "base": { kind: $.TypeKind.Basic, name: "int" }, "tree": "go/token.tree", "last": "sync/atomic.Pointer"}
	);
}
